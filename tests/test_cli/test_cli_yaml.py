...
class TestInferenceConfiguration(unittest.TestCase):
    ...
    def test_missing_model(self):
        ...
        self.assertEqual(str(context.exception), "Model must be provided in config", "Model must be provided in config")
    ...
    def test_invalid_gpu(self):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertIn("GPU must be between 0 and", str(context.exception), "GPU must be between 0 and -1")
    ...
    def test_invalid_batch_size(self, mock_device_count):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertEqual(str(context.exception), "Batch size must be between 2 and 32", "Batch size must be between 2 and 32")
    ...
    def test_invalid_cpu_count(self, mock_device_count):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertEqual(str(context.exception), "Output directory must be provided", "Output directory must be provided")
    ...
    def test_invalid_nuclei_taxonomy(self):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertIn("Nuclei taxonomy must be one of", str(context.exception), "Nuclei taxonomy must be one of the valid options")
    ...
    def test_invalid_memory(self, mock_device_count):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertEqual(str(context.exception), "Memory must be larger than 8GB (8192MB)", "Memory must be larger than 8GB (8192MB)")
    ...
    def test_invalid_command(self, mock_device_count):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertEqual(str(context.exception), "Command must be provided", "Command must be provided")
    ...
    def test_invalid_cpu_count(self, mock_device_count):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertIn("GPU must be between 0 and 3", str(context.exception), "GPU must be between 0 and 3")
    ...
    def test_gpu_with_no_cuda(self, mock_device_count):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertEqual(str(context.exception), "GPU must be between 0 and -1", "GPU must be between 0 and -1")
    ...
    def test_invalid_model(self):
        ...
        with self.assertRaises(AssertionError) as context:
            InferenceConfiguration(invalid_config)
        self.assertIn("Model must be either 'SAM' or 'HIPT'", str(context.exception), "Model must be either 'SAM' or 'HIPT'")
    ...
    def test_process_dataset_filelist(self, mock_device_count):
        ...
        try:
            ...
            config_with_filelist["process_dataset"] = {
                "wsi_filelist": str(csv_path)
            }
    ...
    def test_invalid_dataset_config(self, mock_device_count):
        ...
        self.assertIn("Either 'wsi_folder' or 'wsi_filelist' must be provided, but not both.", str(context.exception))
