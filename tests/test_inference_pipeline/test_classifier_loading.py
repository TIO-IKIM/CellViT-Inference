...
class TestCellViTInferenceLoadClassifier(unittest.TestCase):
    ...
    def test_load_classifier_lizard_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Neutrophil', 1: 'Epithelial', 2: 'Lymphocyte', 3: 'Plasma', 4: 'Eosinophil', 5: 'Connective tissue'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
    ...
    def test_load_classifier_midog_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Mitotic', 1: 'Hard-Negative'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
    ...
    def test_load_classifier_consep_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Other', 1: 'Inflammatory', 2: 'Epithelial', 3: 'Spindle-Shaped'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
    ...
    def test_load_classifier_nucls_main_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Tumor nonMitotic', 1: 'Tumor Mitotic', 2: 'nonTILnonMQ Stromal', 3: 'Macrophage', 4: 'Lymphocyte', 5: 'Plasma Cell', 6: 'Other Nucleus'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
    ...
    def test_load_classifier_nucls_super_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Tumor', 1: 'nonTIL Stromal', 2: 'sTIL', 3: 'Other'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
    ...
    def test_load_classifier_ocelot_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Other Cell', 1: 'Tumor Cell'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
    ...
    def test_load_classifier_panoptils_sam(self):
        ...
        self.assertEqual(self.inference.label_map, {0: 'Other Cells', 1: 'Epithelial Cells', 2: 'Stromal Cells', 3: 'TILs'}, "Label map should be set correctly")
        self.assertIsInstance(self.inference.classifier, LinearClassifier, "Classifier should be a PyTorch module")
