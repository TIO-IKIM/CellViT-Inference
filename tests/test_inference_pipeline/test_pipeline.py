...
class TestCellViTInference(unittest.TestCase):
    ...
    def test_init_with_default_params(self):
        ...
        for method in ['_instantiate_logger', '_load_model', '_check_devices', 
                      '_load_classifier', '_load_inference_transforms', 
                      '_setup_amp', '_setup_worker']:
    ...
    def test_load_model_real_implementation(self):
        ...
        for method in ['_instantiate_logger', '_load_model', '_check_devices', '_load_classifier', 
                    '_load_inference_transforms', '_setup_amp', '_setup_worker']:
